...
#     [string]$OutputPath
# )
$ProjectFilePath="E:\H3VR\H3VR-Supply-Raid\H3VR-Supply-Raid-Code\plugin\SupplyRaid.csproj"
$OutputPath="E:\H3VR\H3VR-Supply-Raid\H3VR-Supply-Raid-Code\plugin\bin\Debug\net35\"
...
$dllPath="E:\H3VR\H3VR-Supply-Raid\H3VR-Supply-Raid-Code\plugin\bin\Debug\net35\SupplyRaid.dll"
$mdbPath="E:\H3VR\H3VR-Supply-Raid\H3VR-Supply-Raid-Code\plugin\bin\Debug\net35\SupplyRaid.dll.mdb"

# 都复制到
$dst = "C:\Users\zec\AppData\Roaming\Thunderstore Mod Manager\DataFolder\H3VR\profiles\sr\BepInEx\plugins\Packer-SupplyRaid"
Copy-Item $dllPath $dst -Force
Copy-Item $mdbPath $dst -Force
echo "Copied $dllPath to $dst"
echo "Copied $mdbPath to $dst"
echo "Done."
